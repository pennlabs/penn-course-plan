...
class SearchBar extends Component {
    ...
    handleSubmit(event) {
        ...
        this.props.startSearch({ searchType: "courseIDSearch", param: event.target.getElementsByTagName("input")[0].value });
    }
            ...
            <div id="searchbar" className="level">
                <span className="level-left">
                    ...
                    <div id="searchSelectContainer">
                        <Dropdown
                            id="searchSelect" update_label def_active={0} def_text="Search By"
                            contents={[
                                ["Course ID", () => {
                                }],
                                ["Keywords", () => {
                    ...
                    <form
                      className="ng-valid ng-dirty ng-valid-parse ng-submitted"
                        onSubmit={this.handleSubmit}
                    >
                        <input
                            id="CSearch" type="text"
                ...
                <span className="level-right">
                    ...
                    <div id="scheduleOptionsContainer">
                        <Dropdown
                            id="scheduleDropdown" def_text="Schedule Options" contents={[
                                ["New", () => {
                    ...
                    <div className="dropdown">
                        ...
                        <div className="dropdown-menu" id="dropdown-menu" role="menu">
                            <div
                                className="dropdown-content ng-pristine ng-untouched ng-valid ng-not-empty"
                                id="sched-select"
                                role="menu"
                            >
                                <a
